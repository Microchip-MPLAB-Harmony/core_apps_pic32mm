...
{"0": {
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  },"1": {
    "doc": "SPI Driver asynchronous - multi instance",
    "title": "SPI Driver asynchronous - multi instance",
    "content": "This example demonstrates how to use multiple instances of the SPI driver in asynchronous mode to communicate with multiple EEPROMs . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/spi/async/spi_multi_instance/readme.html#spi-driver-asynchronous---multi-instance",
    "relUrl": "/apps/driver/spi/async/spi_multi_instance/readme.html#spi-driver-asynchronous---multi-instance"
  },"2": {
    "doc": "SPI Driver asynchronous - multi instance",
    "title": "Description",
    "content": "This example writes and reads data to and from two separate EEPROM connected over two different SPI bus by using multi instance feature of the driver. The example also demonstrates how to setup two different EEPROM transfers at different baud rates. ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/spi/async/spi_multi_instance/readme.html#description",
    "relUrl": "/apps/driver/spi/async/spi_multi_instance/readme.html#description"
  },"3": {
    "doc": "SPI Driver asynchronous - multi instance",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/driver/spi/async/spi_multi_instance/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | pic32mm_usb_curiosity.X | MPLABX project for PIC32MM USB Curiosity board | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/spi/async/spi_multi_instance/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi/async/spi_multi_instance/readme.html#downloading-and-building-the-application"
  },"4": {
    "doc": "SPI Driver asynchronous - multi instance",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mm_usb_curiosity.X | PIC32MM USB Curiosity board | . |   |   | . | To run the demo, the following additional hardware are required: . | Two EEPROM 4 Click boards | . | . Setting up PIC32MM USB Curiosity board . | Connect micro USB cable to the ‘USB1’ connector on the board to the computer | Install two EEPROM 4 Click boards on to the two mikroBUS sockets(J4 &amp; J12) of PIC32MM USB Curiosity board | Note: Ensure that the series resistors on the mikroBUS headers are of value 0 Ohms | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/spi/async/spi_multi_instance/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi/async/spi_multi_instance/readme.html#setting-up-the-hardware"
  },"5": {
    "doc": "SPI Driver asynchronous - multi instance",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON when the data read from the EEPROMs matches with the data written to the EEPROMs | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MM USB Curiosity board | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/spi/async/spi_multi_instance/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi/async/spi_multi_instance/readme.html#running-the-application"
  },"6": {
    "doc": "SPI Driver asynchronous - multi instance",
    "title": "SPI Driver asynchronous - multi instance",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/spi/async/spi_multi_instance/readme.html",
    "relUrl": "/apps/driver/spi/async/spi_multi_instance/readme.html"
  },"7": {
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/usart/async/usart_echo/readme.html#usart-driver-asynchronous---usart-echo",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/usart/async/usart_echo/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/usart/async/usart_echo/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/usart/async/usart_echo/readme.html#downloading-and-building-the-application"
  },"10": {
    "doc": "USART driver asynchronous - USART echo",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mm_usb_curiosity.X | PIC32MM USB Curiosity board | . |   |   | . | To run the demo, the following additional hardware are required: . | USB UART click board | . | . Setting up PIC32MM USB Curiosity board . | Connect micro USB cable to the ‘USB1’ connector on the board to the computer | Install the USB UART click board on to the mikroBUS socket J4 of PIC32MM USB Curiosity board | Connect mini USB cable to the USB UART click board. This will enumerate the USB to UART port | Note: Ensure that the series resistors on the mikroBUS headers are of value 0 Ohms | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/usart/async/usart_echo/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/usart/async/usart_echo/readme.html#setting-up-the-hardware"
  },"11": {
    "doc": "USART driver asynchronous - USART echo",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Type a character and observe the output on the console as shown below: . | LED toggles each time the character is echoed | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MM USB Curiosity board | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/usart/async/usart_echo/readme.html#running-the-application",
    "relUrl": "/apps/driver/usart/async/usart_echo/readme.html#running-the-application"
  },"12": {
    "doc": "USART driver asynchronous - USART echo",
    "title": "USART driver asynchronous - USART echo",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/usart/async/usart_echo/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/usart/sync/usart_echo/readme.html#usart-driver-synchronous---usart-echo",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/usart/sync/usart_echo/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/usart/sync/usart_echo/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#downloading-and-building-the-application"
  },"16": {
    "doc": "USART driver synchronous - USART echo",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mm_usb_curiosity.X | PIC32MM USB Curiosity board | . |   |   | . | To run the demo, the following additional hardware are required: . | USB UART click board | . | . Setting up PIC32MM USB Curiosity board . | To run the demo, the following additional hardware are required: . | USB UART click board | . | Connect micro USB cable to the ‘USB1’ connector on the board to the computer | Install an USB UART click board on to the mikroBUS socket J4 | Connect mini USB cable between PC and the USB UART click board | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/usart/sync/usart_echo/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#setting-up-the-hardware"
  },"17": {
    "doc": "USART driver synchronous - USART echo",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the “USB to UART” COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application project using its IDE | See the following message in the console: . | Type 10 characters in terminal | Entered 10 characters is echoed back and LED is toggled | . Following table provides the LED names: . | Board | LED Name | . | PIC32MM USB Curiosity board | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/usart/sync/usart_echo/readme.html#running-the-application",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#running-the-application"
  },"18": {
    "doc": "USART driver synchronous - USART echo",
    "title": "USART driver synchronous - USART echo",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/usart/sync/usart_echo/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/fs/nvm_fat/readme.html#fat-filesystem-using-nvm-media",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/fs/nvm_fat/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/fs/nvm_fat/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/fs/nvm_fat/readme.html#downloading-and-building-the-application"
  },"22": {
    "doc": "FAT filesystem using NVM Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mm_usb_curiosity.X | PIC32MM USB Curiosity board | . |   |   | . Setting up PIC32MM USB Curiosity board . | Connect micro USB cable to the ‘USB1’ connector on the board to the computer | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/fs/nvm_fat/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/fs/nvm_fat/readme.html#setting-up-the-hardware"
  },"23": {
    "doc": "FAT filesystem using NVM Media",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | Press Switch to start the file operations | The LED is turned ON when the File FILE.TXT has the app data “Hello World” written in it | . Refer to the following table for switch and LED name: . | Board | Switch name | LED Name | . | PIC32MM USB Curiosity board | S1 | LED1 | . |   |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/fs/nvm_fat/readme.html#running-the-application",
    "relUrl": "/apps/fs/nvm_fat/readme.html#running-the-application"
  },"24": {
    "doc": "FAT filesystem using NVM Media",
    "title": "FAT filesystem using NVM Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/fs/nvm_fat/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/fs/sdspi_fat/readme.html#fat-filesystem-using-sdspi-media",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/fs/sdspi_fat/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#console-debug-system-service-using-uart",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#downloading-and-building-the-application"
  },"40": {
    "doc": "Console Debug System Service using UART",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mm_usb_curiosity.X | PIC32MM USB Curiosity board | . |   |   | . | To run the demo, the following additional hardware are required: . | USB UART click board | . | . Setting up PIC32MM USB Curiosity board . | Connect micro USB cable to the ‘USB1’ connector on the board to the computer | Install the USB UART click board on to the mikroBUS socket J4 of PIC32MM USB Curiosity board | Connect mini USB cable to the USB UART click board. This will enumerate the USB to UART port | Note: Ensure that the series resistors on the mikroBUS headers are of value 0 Ohms | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#running-the-application",
    "relUrl": "/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#running-the-application"
  },"42": {
    "doc": "Console Debug System Service using UART",
    "title": "Console Debug System Service using UART",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/system/time/sys_time_multiclient/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/system/time/sys_time_multiclient/readme.html#downloading-and-building-the-application"
  },"46": {
    "doc": "Time System Service multi-client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mm_usb_curiosity.X | PIC32MM USB Curiosity board | . |   |   | . Setting up PIC32MM USB Curiosity board . | Connect micro USB cable to the ‘USB1’ connector on the board to the computer | Install the USB UART click board on to the mikroBUS socket J4 of PIC32MM USB Curiosity board | Connect mini USB cable to the USB UART click board. This will enumerate the USB to UART port | . Note: Ensure that the series resistors on the mikroBUS headers are of value 0 Ohms . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/system/time/sys_time_multiclient/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/system/time/sys_time_multiclient/readme.html#setting-up-the-hardware"
  },"47": {
    "doc": "Time System Service multi-client",
    "title": "Running the Application",
    "content": "For PIC32MM USB Curiosity board and PIC32 Ethernet Starter Kit : . | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Observe the following message getting printed on the console every two seconds . | Press the switch and observe the following output on the terminal (highlighted in red box) . | “Delay time = 500 ms” indicates the amount of time spent during the delay | “Single shot timer of 100 ms expired” is printed only once on every switch press | . | LED indicates the periodic timer functionality . | LED is toggled periodically every one second | . | . Refer to the following table for switch and LED name: . | Board | Switch name | LED Name | . | PIC32MM USB Curiosity board | S1 | LED1 | . |   |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/system/time/sys_time_multiclient/readme.html#running-the-application",
    "relUrl": "/apps/system/time/sys_time_multiclient/readme.html#running-the-application"
  },"48": {
    "doc": "Time System Service multi-client",
    "title": "Time System Service multi-client",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/system/time/sys_time_multiclient/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/i2c/async/i2c_eeprom/readme.html#i2c-driver-asynchronous---i2c-eeprom",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/i2c/async/i2c_eeprom/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/i2c/async/i2c_eeprom/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#downloading-and-building-the-application"
  },"52": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mm_usb_curiosity.X | PIC32MM USB Curiosity board | . |   |   | . | To run the demo, the following additional hardware are required: . | One EEPROM 3 Click board | . | . Setting up PIC32MM USB Curiosity board . | Connect micro USB cable to the ‘USB1’ connector on the board to the computer | Install the EEPROM 3 Click board on to the mikroBUS socket J4 of PIC32MM USB Curiosity board | Note: Ensure that the series resistors on the mikroBUS headers are of value 0 Ohms | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/i2c/async/i2c_eeprom/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#setting-up-the-hardware"
  },"53": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON when the value read from the EEPROM matched with the written value | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MM USB Curiosity board | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/i2c/async/i2c_eeprom/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#running-the-application"
  },"54": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "I2C driver asynchronous - I2C EEPROM",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mm/apps/driver/i2c/async/i2c_eeprom/readme.html",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html"
  },"55": {
    "doc": "Release notes",
    "title": "Microchip MPLAB® Harmony 3 Release Notes",
    "content": " ",
    "url": "http://localhost:4000/core_apps_pic32mm/release_notes.html#microchip-mplab-harmony-3-release-notes",
    "relUrl": "/release_notes.html#microchip-mplab-harmony-3-release-notes"
  },"56": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MM family  v3.2.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | PIC32MM USB Curiosity board | 9 | . | PIC32MM Curiosity board | 1 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.05 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.3.0 | . | MPLAB® XC32 C/C++ Compiler v4.21 | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mm-family--v320",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mm-family--v320"
  },"57": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MM family  v3.1.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | PIC32MM USB Curiosity board | 9 | . | PIC32MM Curiosity board | 1 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.00 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.1.9 | . | MPLAB® XC32 C/C++ Compiler v4.10 | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mm-family--v310",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mm-family--v310"
  },"58": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MM family  v3.0.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | PIC32MM USB Curiosity board](https://www.microchip.com/DevelopmentTools/ProductDetails/DM320107) | 9 | . | PIC32MM Curiosity board | 1 | . New Features . | All applications are updated to work with both MHC and MCC tools | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v5.50 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.8.0 | . | MPLAB® XC32 C/C++ Compiler v3.01 | . ",
    "url": "http://localhost:4000/core_apps_pic32mm/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mm-family--v300",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mm-family--v300"
  },"59": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mm/release_notes.html",
    "relUrl": "/release_notes.html"
  },"60": {
    "doc": "Harmony 3 driver and system service application examples for PIC32MM family",
    "title": "Harmony 3 driver and system service application examples for PIC32MM family",
    "content": "[![MCHP](https://www.microchip.com/ResourcePackages/Microchip/assets/dist/images/logo.png)](https://www.microchip.com) # Harmony 3 driver and system service application examples for PIC32MM family MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) This repository contains the MPLAB® Harmony 3 driver and system service application examples for PIC32MM family - [Release Notes](/core_apps_pic32mm/release_notes.html) - [MPLAB® Harmony License](/core_apps_pic32mm/mplab_harmony_license.html) To clone or download these applications from Github, go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/core_apps_pic32mm) and then click **Clone** button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these [instructions](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki). ## Contents Summary | Folder | Description | --- | --- | apps | Contains driver and system service example applications | docs | Contains documentation in html format for offline viewing (to be used only after cloning this repository onto a local machine). Use [github pages](https://microchip-mplab-harmony.github.io/core_apps_pic32mm/) of this repository for viewing it online. | ## Code Examples The following applications are provided to demonstrate the typical or interesting usage models of one or more peripheral libraries. | Name | Description | ---- | ----------- | [I2C driver asynchronous - I2C EEPROM](/core_apps_pic32mm/apps/driver/i2c/async/i2c_eeprom/readme.html) | This example application shows how to use the I2C driver in asynchronous mode to perform operations on the EEPROM | [SPI Driver asynchronous - multi instance](/core_apps_pic32mm/apps/driver/spi/async/spi_multi_instance/readme.html) | This example demonstrates how to use multiple instances of the SPI driver in asynchronous mode to communicate with multiple EEPROMs | [USART driver asynchronous - USART echo](/core_apps_pic32mm/apps/driver/usart/async/usart_echo/readme.html) | This example echoes the received characters over the console using the USART driver in asynchronous mode | [USART driver synchronous - USART echo](/core_apps_pic32mm/apps/driver/usart/sync/usart_echo/readme.html) | This example echoes the received characters over the console using the USART driver in synchronous mode | [FAT filesystem using NVM Media](/core_apps_pic32mm/apps/fs/nvm_fat/readme.html) | This application shows an example of implementing a FAT disk in the device internal Flash memory | [FAT filesystem using SDSPI Media](/core_apps_pic32mm/apps/fs/sdspi_fat/readme.html) | This application shows an example of using the MPLAB Harmony File System to access and modify the contents of a SD card using the SDSPI driver and the SPI PLIB | [FreeRTOS basic](/core_apps_pic32mm/apps/rtos/freertos/basic_freertos/readme.html) | This example application demonstrates context switching between different tasks having different priorites | [Console Debug System Service using UART](/core_apps_pic32mm/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html) | This example application demonstrates the UART based console and debug system service | [Time System Service multi-client](/core_apps_pic32mm/apps/system/time/sys_time_multiclient/readme.html) | This example application demonstrates the multi-client system timer functionality | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_pic32mm/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/Microchip-MPLAB-Harmony/core_apps_pic32mm.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_pic32mm/releases/latest) [![Latest release date](https://img.shields.io/github/release-date/Microchip-MPLAB-Harmony/core_apps_pic32mm.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_pic32mm/releases/latest) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/core_apps_pic32mm.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_pic32mm/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/core_apps_pic32mm.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/core_apps_pic32mm.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/core_apps_pic32mm.svg?style=social)]() ",
    "url": "http://localhost:4000/core_apps_pic32mm/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "core_apps_pic32mm";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 driver and system service application examples for PIC32MM family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/core_apps_pic32mm/assets/css/just-the-docs-' + theme + '.css');
}
